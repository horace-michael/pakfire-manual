...
wget https://github.com/horace-michael/pakfire-manual/releases/latest/download/pakfire-manual-v1.5.4.ipfire
wget https://github.com/horace-michael/pakfire-manual/releases/latest/download/pakfire-manual-v1.5.4.ipfire.sha256
wget https://github.com/horace-michael/pakfire-manual/releases/latest/download/pakfire-manual-v1.5.4.ipfire.asc
...
sha256sum -c pakfire-manual-v1.5.4.ipfire.sha256
gpg --verify pakfire-manual-v1.5.4.ipfire.asc pakfire-manual-v1.5.4.ipfire

# Copy to IPFire:
scp pakfire-manual-v1.5.4.ipfire root@<ipfire-host>:/opt/pakfire/tmp/

# On IPFire as root:
cd /opt/pakfire/tmp
tar -xvf pakfire-manual-v1.5.4.ipfire
