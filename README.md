...
# Copy to IPFire:
scp pakfire-manual-v1.6.3.ipfire root@<ipfire-host>:/opt/pakfire/tmp/

# Switch on the IPFire machine:

# On the IPFire machine: import the pakfire keys in gpg keyring -  the official IPFire Pakfire signing keys live in /opt/pakfire/, not in standard gpg keyrings.
...
# On the IPFire machine: verify that pakfire keys were imported:
